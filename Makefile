# This Makefile is for the Crypt::FNA extension to perl.
#
...
#     VERSION_FROM => q[lib/Crypt/FNA.pm]
...
H_FILES  = 
MAN1PODS = 
MAN3PODS = lib/Crypt/FNA.pm \
	lib/Crypt/FNA/Validation.pm
...
TO_INST_PM = lib/Crypt/FNA.pm \
	lib/Crypt/FNA/Validation.pm

PM_TO_BLIB = lib/Crypt/FNA/Validation.pm \
...
FNA.def: Makefile.PL
	$(PERLRUN) -MExtUtils::Mksymlists \
     -e "Mksymlists('NAME'=>\"Crypt::FNA\", 'DLBASE' => '$(BASEEXT)', 'DL_FUNCS' => {  }, 'FUNCLIST' => [], 'IMPORTS' => {  }, 'DL_VARS' => []);"
...
manifypods : pure_all  \
	...
	$(NOECHO) $(POD2MAN) --section=3 --perm_rw=$(PERM_RW) \
	  lib/Crypt/FNA/Validation.pm $(INST_MAN3DIR)\Crypt.FNA.Validation.$(MAN3EXT) \
	  lib/Crypt/FNA.pm $(INST_MAN3DIR)\Crypt.FNA.$(MAN3EXT) 
...
metafile : create_distdir
	...
	$(NOECHO) $(ECHO) "version:            0.54" >> META_new.yml
	...
	$(NOECHO) $(ECHO) "generated_by:       ExtUtils::MakeMaker version 6.4801" >> META_new.yml
...
pm_to_blib : $(TO_INST_PM)
	$(NOECHO) $(ABSPERLRUN) -MExtUtils::Install -e "pm_to_blib({@ARGV}, '$(INST_LIB)\auto', '$(PM_FILTER)')" -- \
	  lib/Crypt/FNA/Validation.pm blib\lib\Crypt\FNA\Validation.pm \
	  lib/Crypt/FNA.pm blib\lib\Crypt\FNA.pm 
